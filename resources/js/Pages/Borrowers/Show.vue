    ...
    <AuthenticatedLayout>
       <PageContent>
            <div class="flex gap-4 items-start">
                <div class="4/9">
                    <BorrowerDetails :borrower="borrower" :loanHistory="loanHistory" />
                </div>
                <div class="flex-1">
                    <div class="flex gap-2 justify-end mb-3" v-if="borrower.activeLoan">
                        ...
                        <Link :href="'/loans/payment-history/' + borrower.activeLoan.id" class="px-8 py-1 text-white bg-teal-800 rounded shadow hover:bg-teal-600 dark:bg-teal-400 dark:text-teal-900">
